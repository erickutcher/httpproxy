...
unsigned char ws2_32_state = 0;	// 0 = Not running, 1 = running.
	...
	bool InitializeWS2_32()
	{
		...
		VALIDATE_FUNCTION_POINTER( SetFunctionPointer( hModule_ws2_32, ( void ** )&_WSASendTo, "WSASendTo" ) )
		VALIDATE_FUNCTION_POINTER( SetFunctionPointer( hModule_ws2_32, ( void ** )&_WSARecvFrom, "WSARecvFrom" ) )
		...
		VALIDATE_FUNCTION_POINTER( SetFunctionPointer( hModule_ws2_32, ( void ** )&_htons, "htons" ) )
