...
#define WS2_32_STATE_RUNNING		1
	...
	#define _WSASendTo		WSASendTo
	#define _WSARecvFrom	WSARecvFrom
	...
	typedef INT ( WSAAPI *pWSAAddressToStringA )( LPSOCKADDR lpsaAddress, DWORD dwAddressLength, LPWSAPROTOCOL_INFO lpProtocolInfo, LPSTR lpszAddressString, LPDWORD lpdwAddressStringLength );
	...
	typedef int ( WSAAPI *pWSARecvFrom )( SOCKET s, LPWSABUF lpBuffers, DWORD dwBufferCount, LPDWORD lpNumberOfBytesRecvd, LPDWORD lpFlags, struct sockaddr *lpFrom, LPINT lpFromlen, LPWSAOVERLAPPED lpOverlapped, LPWSAOVERLAPPED_COMPLETION_ROUTINE lpCompletionRoutine );
	...
	typedef u_short ( WSAAPI *phtons )( u_short hostshort );
	...
	extern pWSASendTo		_WSASendTo;
	extern pWSARecvFrom		_WSARecvFrom;
