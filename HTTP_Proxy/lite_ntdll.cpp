...
#include "lite_ntdll.h"
	...
	bool InitializeNTDLL()
	{
		...
		VALIDATE_FUNCTION_POINTER( SetFunctionPointer( hModule_ntdll, ( void ** )&__vsnprintf, "_vsnprintf" ) )
		VALIDATE_FUNCTION_POINTER( SetFunctionPointer( hModule_ntdll, ( void ** )&__vsnwprintf, "_vsnwprintf" ) )
